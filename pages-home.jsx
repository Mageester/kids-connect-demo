    ...
    <div className="page-enter" ref={ref}>
          ...
          <div className="hero__grid">
            <div>
              ...
              <div className="hero__actions hero-el hero-el-4">
                <a className="btn btn--primary btn--lg" onClick={() => onNavigate('programs')}>
                  View Programs <ArrowRight size={18} />
                </a>
                <a className="btn btn--outline btn--lg" onClick={() => onNavigate('contact')}>
                  Book a Call
                </a>
              </div>
              <div className="hero-el hero-el-5" style={{marginTop:28,display:'flex',gap:10,flexWrap:'wrap'}}>
                {['Ages 2–13','2–5 per group','Weekday & Weekend','Funding Eligible'].map((tag,i) => (
                  <span key={i} className="badge badge--primary" style={{fontSize:'0.8rem'}}>{tag}</span>
                ))}
              </div>
            </div>
            <div className="hero__image-wrap hero-img" style={{boxShadow:'0 24px 64px rgba(0,0,0,0.14)'}}>
              <img src="uploads/main-space_-1024x627.webp" alt="Kids Connect Play Space in Burnaby"
          ...
          <div className="grid-2" style={{alignItems:'flex-start'}}>
            <div>
              ...
              <div style={{display:'flex',gap:16,flexWrap:'wrap'}}>
                <a className="btn btn--primary" onClick={() => onNavigate('programs')}>Program Details <ArrowRight size={18} /></a>
                <a className="btn btn--outline" onClick={() => onNavigate('contact')}>Inquire Today</a>
              </div>
            </div>
            ...
            {[
              {
                ...
                iconPath2:<React.Fragment><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 00-3-3.87"></path><path d="M16 3.13a4 4 0 010 7.75"></path></React.Fragment>,
              ...
              <div key={i} className="card reveal" style={{transitionDelay:`${i*0.12}s`}}>
                <div className={`card__icon card__icon--${card.type}`}>
                  {i===0 && <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 00-3-3.87"></path><path d="M16 3.13a4 4 0 010 7.75"></path></svg>}
                  {i===1 && <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"></path></svg>}
                  {i===2 && <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M8 14s1.5 2 4 2 4-2 4-2"></path><line x1="9" y1="9" x2="9.01" y2="9"></line><line x1="15" y1="9" x2="15.01" y2="9"></line></svg>}
                </div>
        ...
        <div className="container">
          <div className="grid-2">
            ...
            <div>
              ...
              <a className="btn btn--outline" onClick={() => onNavigate('about')}>Read Crista's Full Story <ArrowRight size={18} /></a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="grid-3">
            {[
              ...
              <div key={i} className="testimonial reveal" style={{transitionDelay:`${i*0.12}s`}}>
      ...
      <section className="reveal" style={{background:'var(--color-primary-light)',padding:'48px 0'}}>
        <div className="container" style={{textAlign:'center'}}>
          ...
          <a className="btn btn--primary btn--sm" onClick={() => onNavigate('contact')}>Ask About Funding</a>
        </div>
      </section>
